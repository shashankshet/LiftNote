...
const Chest = () => {
  ...
  const chestExercises = [
    { name: "Bench Press", image: "static/images/benchpress.png" },
    {
      ...
      image: "static/images/machinechestpress.png",
    },
    {
      name: "Incline Bench Press",
      image: "static/images/inclinechestpress.png",
    },
    { name: "Chest Fly", image: "static/images/chestfly.png" },
    { name: "Cable Fly", image: "static/images/cablefly.png" },
    { name: "Push Ups", image: "static/images/pushup.png" },
  ];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4 sm:p-6">
      <h1 className="text-2xl font-bold mb-6 mt-4 sm:mt-8">Chest Exercises</h1>
